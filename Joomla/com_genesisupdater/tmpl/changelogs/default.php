...
/** @var \Joomla\Component\Genesisupdater\Administrator\View\Changelogs\HtmlView $this */
...
?>
<form action="<?php echo Route::_('index.php?option=com_genesisupdater&view=changelogs'); ?>" method="post" name="adminForm" id="adminForm">
	<div class="row">
		<div class="col-md-12">
				...
				<?php else : ?>
					<table class="table" id="changelogList">
						<caption class="visually-hidden">
							<?php echo Text::_('COM_GENESISUPDATER_CHANGELOGS_TABLE_CAPTION'); ?>
						</caption>
						<thead>
							<tr>
								...
								<th scope="col">
									<?php echo Text::_('COM_GENESISUPDATER_FIELD_PRODUCT_LABEL'); ?>
								</th>
						...
						<?php foreach ($this->items as $i => $item) :
							...
							<tr class="tr-<?php echo (int) $item->id; ?>">
								...
								<th scope="row">
									<?php if ($canEdit) : ?>
										<a href="<?php echo Route::_('index.php?option=com_genesisupdater&task=changelog.edit&id=' . (int) $item->id); ?>">
