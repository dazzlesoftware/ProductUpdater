CREATE TABLE IF NOT EXISTS `#__genesisupdater_products` (
...
CREATE TABLE IF NOT EXISTS `#__genesisupdater_changelogs` (
  `id` INT(11) UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `#__genesisupdater_bundles` (
