...
3. Open **Components > Genesis Updater**.
...
1. Open **Components > Genesis Updater > Products** and select **New**.
...
1. Open **Components > Genesis Updater > Changelogs** and select **New**.
...
3. Set **Menu Item Type** to **Genesis Updater > Downloads**.
...
Open **Components > Genesis Updater > Options** and use the Downloads settings to configure:
