...
namespace Joomla\Component\Genesisproductupdater\Administrator\Extension;
...
/**
 * Component class for com_genesisproductupdater.
 */
class ProductUpdaterComponent extends MVCComponent implements BootableExtensionInterface
{
    /**
