...
class ChangelogModel extends AdminModel
{
     ...
     * @var  string
     */
    public $typeAlias = 'com_genesisproductupdater.changelog';

    /**
     * @var  string
     */
    protected $text_prefix = 'COM_GENESISPRODUCTUPDATER_CHANGELOG';
    ...
    {
        $form = $this->loadForm('com_genesisproductupdater.changelog', 'changelog', ['control' => 'jform', 'load_data' => $loadData]);
    ...
    protected function loadFormData()
    {
        ...
        $data = $app->getUserState('com_genesisproductupdater.edit.changelog.data', []);
        ...
        $this->preprocessData('com_genesisproductupdater.changelog', $data);
    ...
    public function save($data)
    {
        ...
        if (!empty($data['product_id'])) {
            ...
            if ($productTitle) {
                $data['title'] = $productTitle . ' ' . \Joomla\CMS\Language\Text::_('COM_GENESISPRODUCTUPDATER_CHANGELOG_TITLE_SUFFIX');
            }
        }
        ...
        if ($result) {
            ...
            if ($id > 0) {
                try {
                    ...
                    ProductUpdaterHelper::generateProduct((int) $data['product_id']);
                } catch (\Throwable $e) {
