...
/**
 * Collects the platform generators registered by the "productupdaterplatform"
 * plugin group. Each plugin listens for the `onProductUpdaterRegisterPlatforms`
...
class PlatformRegistry
{
     ...
     * "productupdaterplatform" plugin exactly once per request.
     *
     * @return  void
     */
