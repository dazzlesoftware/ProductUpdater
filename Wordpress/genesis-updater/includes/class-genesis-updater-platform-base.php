 ...
 *   1. Copy includes/platforms/class-genesis-updater-platform-wordpress.php as a starting point.
 *   2. Extend Genesis_Updater_Platform_Base and implement get_slug(), get_label(),
 *      get_file_extension() and generate().
 *   3. Register it with the 'genesis_updater_register_platforms' filter (see bottom of
 *      class-genesis-updater-platform-joomla.php for the pattern), or just require the
 *      file from genesis-updater.php.
 * It will then automatically show up in the product editor's platform
 * dropdown and be included in "Generate files".
 */
abstract class Genesis_Updater_Platform_Base {
	 ...
	 *                        Genesis_Updater_Product_Metaboxes::get_row_fields()).
