 ...
 */
class Product_Updater_Changelog {

	const POST_TYPE = 'pu_changelog';
	...
	public static function get_category_choices() {
		return array(
			'addition'   => __( 'Addition', 'genesis-product-updater' ),
			'change'     => __( 'Change', 'genesis-product-updater' ),
			'fix'        => __( 'Fix', 'genesis-product-updater' ),
			'remove'     => __( 'Remove', 'genesis-product-updater' ),
			'security'   => __( 'Security', 'genesis-product-updater' ),
			'deprecated' => __( 'Deprecated', 'genesis-product-updater' ),
			'language'   => __( 'Language', 'genesis-product-updater' ),
			'note'       => __( 'Note', 'genesis-product-updater' ),
		);
	}
	...
	public static function get_changelog_post_id_for_product( $product_id ) {
		$posts = get_posts(
			array(
				...
				'post_status'    => 'publish',
				'fields'         => 'ids',
				'meta_key'       => '_product_updater_changelog_product_id',
	...
	public static function get_rows( $changelog_post_id ) {
		$rows = get_post_meta( $changelog_post_id, '_product_updater_changelog_rows', true );
