# Genesis Product Updater for WordPress

Genesis Product Updater manages self-hosted update feeds for Joomla extensions, WordPress plugins and themes, and mobile applications from the WordPress administrator. It can also publish a styled Downloads page with changelog popups, download counts, file sizes, preview images, and mobile store links.

> This project is currently a work in progress.

## Installation

1. Copy the `genesis-product-updater` directory to `wp-content/plugins/`, or install a ZIP of the directory from **Plugins > Add New > Upload Plugin**.
2. Activate **Genesis Product Updater**.
3. Open **Genesis Product Updater > Settings**.
...
1. Open **Genesis Product Updater > Products > Add New Product**.
...
1. Open **Genesis Product Updater > Changelogs** and create a changelog.
...
Saving supported content generates the appropriate update files in the configured output folder. Use **Genesis Product Updater > Settings > Regenerate All Files Now** after changing the output location or when rebuilding every feed.
...
Open **Genesis Product Updater > Settings** to configure:
